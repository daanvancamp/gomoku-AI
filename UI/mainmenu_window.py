...
class GomokuApp(Tk):
	def __init__(self):
		...
		try:
			self.wm_iconphoto(False, ImageTk.PhotoImage(Image.open('res/ico.png')))
		except TclError:
		...
		self.button_1 = ttk.Button(self.tab1, text="New Game", command=lambda: self.start_new_game(), style="TButton")
		...
		self.radiobutton1 = ttk.Radiobutton(self.tab1, text="Human", variable=self.var_playerType1, value="Human", command=lambda: self.set_player_type(0),style="TRadiobutton")
		self.radiobutton1.grid(row=3, column=0, sticky="w", padx=distance_from_left_side)
		self.radiobutton2 = ttk.Radiobutton(self.tab1, text="Test Algorithm", variable=self.var_playerType1, value="Test Algorithm", command=lambda: self.set_player_type(0),style="TRadiobutton")
		self.radiobutton2.grid(row=4, column=0, sticky="w", padx=distance_from_left_side)
		self.radiobutton3 = ttk.Radiobutton(self.tab1, text="AI-Model", variable=self.var_playerType1, value="AI-Model", command=lambda: self.set_player_type(0),style="TRadiobutton")
		self.radiobutton3.grid(row=5, column=0, sticky="w", padx=distance_from_left_side)

		self.radiobutton4 = ttk.Radiobutton(self.tab1, text="Human", variable=self.var_playerType2, value="Human", command=lambda: self.set_player_type(1),style="TRadiobutton")
		self.radiobutton4.grid(row=3, column=1, sticky="w")
		self.radiobutton5 = ttk.Radiobutton(self.tab1, text="Test Algorithm", variable=self.var_playerType2, value="Test Algorithm", command=lambda: self.set_player_type(1),style="TRadiobutton")
		self.radiobutton5.grid(row=4, column=1, sticky="w")
		self.radiobutton6 = ttk.Radiobutton(self.tab1, text="AI-Model", variable=self.var_playerType2, value="AI-Model", command=lambda: self.set_player_type(1),style="TRadiobutton")
		...
		ttk.Label(self.tab2)
		#row 0
		self.button_2 = ttk.Button(self.tab2, text="Train", style="TButton", command=lambda: self.start_new_training())
		...
		self.button_4 = ttk.Button(self.tab3, text="...",style="TButton", command=lambda: self.browse_files())
		...
		self.button_5 = ttk.Button(self.tab3, text="Play", style="TButton", command=lambda: self.start_new_replay())
