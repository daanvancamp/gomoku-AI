...
class EvaluateWindow(window.BaseWindow): # player 1 is AI, player 2 is AI/Test Algorithm
	...
	def start_new_evaluation(self):
		match self.var_p2_type.get():
			case "AI-Model":
				self.master.controller = AI_vs_AI_evaluation_controller.AI_vs_AI_EvaluationController(self.master,self.var_color_p1.get(),self.var_p1_model.get(),self.var_p2_model.get(),self.var_allow_overrule.get())
			case "Test Algorithm":
